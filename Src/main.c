...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	ISM330DHCX_io_ctx.Init = CUSTOM_ISM330DHCX_0_I2C_Init;
	ISM330DHCX_io_ctx.DeInit = CUSTOM_ISM330DHCX_0_I2C_DeInit;
	ISM330DHCX_io_ctx.ReadReg = CUSTOM_ISM330DHCX_0_I2C_ReadReg;
	ISM330DHCX_io_ctx.WriteReg = CUSTOM_ISM330DHCX_0_I2C_WriteReg;
